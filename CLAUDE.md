...
at <= 20M ops/frame, and the binary at <= 35% of 2^27 words. MEASURED baseline (2026-09-06,
`scratchpad/12m/gamespeed.py`, 10x100 frames on the padded game binary): **80th-pct run
26,001,449 ops/frame** and **125,492,170 words = 93.50% of 2^27** -- both FAIL. The gap is -23.1%
on speed, not the -40% the old unrepresentative ~33.4M trajectory figure implied. `docs/handoff-m4-nine-levels.md` is still the M4 reference.
