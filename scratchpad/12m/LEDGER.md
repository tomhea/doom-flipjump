...
| G7 | M6 | **FULL-GAME BASELINE** on the padded shipped binary (`doom_e1m1_menu_p105.fjm`), the FIRST run of the real success criterion: `gamespeed.py --runs 10 --frames 100` | run spread 13,094,573 .. 33,197,649 (2.54x) | mean 21,408,048 / **p80 26,001,449** | **both metrics FAIL** | 125,492,170 words = 93.50% of 2^27 (DATA == SPAN, 1 segment); file 36,442,805 B; menu+startup 538,417 ops calibrated out. ⚠ Supersedes the ~33.4M trajectory figure: that was m2_std_gate's door route, near the TOP of the range. Gap to 20M is 6.0M, not 13.4M. |
