...
prog = "\n".join([
    ...
    "hex.zero 4, ds", "hex.set 4, dn, %d" % NSS,
    "dl:", "hex.cmp 4, ds, dn, dbody, ddone, ddone",
    "dbody:", "hex.set w/4, dq, sshead", "hex.ptr_index dp, dq, ds", "hex.read_byte dh, dp",
    "wl:", "hex.set 2, dc, 0xFF", "hex.cmp 2, dh, dc, wbody, wdone, wbody",
    "wbody:", "hex.print_as_digit 4, ds, 0", "stl.output 58", "hex.print_as_digit 2, dh, 0",
    "stl.output 10",
    "hex.set w/4, dq, thnext", "hex.ptr_index dp, dq, dh", "hex.read_byte dh, dp", ";wl",
    "wdone:", "hex.inc 4, ds", ";dl",
    "ddone:", "stl.loop",
    "wmagic: hex.vec 2", "mk: hex.vec 2", "ds: hex.vec 4", "dn: hex.vec 4", "dh: hex.vec 2", "dc: hex.vec 2",
