"""OPTIONS A+B fast gate: stock E1M1, DEG package + DEG_DDA_FACES=1 + DEG_HD_BUDGET=2,
byte-exact vs the equally-knobbed oracle at 4 viewpoints."""
import sys
import tempfile
...
VPS = [(664, 291, 0x18000000),        # two near sprites: the HD budget's riskiest case
       (1272, -724, 1073741824),      # stairs: the DDA fast path under stacked pieces
