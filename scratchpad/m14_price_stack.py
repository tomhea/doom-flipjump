...
# PRICING stack_steps=False (handoff-perf.md §7c option d): the largest untried picture block,
# and the only remaining option that does not contradict a preference the owner has stated.
# ⚠ A MEASUREMENT, NOT A CANDIDATE -- it draws a different picture (stairs lose their stacked
# step faces) and stays unapplied until the owner has seen it priced (§7 "to suggest, not apply").
abl = "nostack"
CACHE = ROOT / "scratchpad/fjmcache/m14_nostack.fjm"
