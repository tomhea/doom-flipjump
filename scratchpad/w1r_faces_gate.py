"""W1R-FACES fast gate: stock E1M1, W1R+FT1+plane_near+steps (+grain), no things/sky.

Byte-exact vs the oracle at 3 viewpoints with real step faces on screen -- derisks the
face_pattern fj path before the 18-minute full-stack lite build.
"""
import sys
import tempfile
...
main = emit_wall_renderer(mw, "E1M1", cfg, tier="render")
