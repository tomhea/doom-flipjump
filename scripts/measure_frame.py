...
def main():
    ...
    # --floor-mode / --wall-mode / --raster-mode named emitter parameters that are constants now
    # (W1R walls, FT1 floors, the lines raster); every other tier is in the history.
    ...
    print(f"map={args.map} tier={WR.TIER} viewpoint=({vx},{vy},{va}) ablate={label} "
